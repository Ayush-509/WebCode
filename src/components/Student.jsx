  ...
  return (
    <div className='bg-blue-500 h-[100vh] w-[100vw] flex justify-center items-center'>
        <div className="login bg-white w-[40vw] h-[40vh] rounded-xl bg-opacity-60 flex flex-col items-center">
            <p className='font-extrabold text-xl mt-4'>Student Login</p>
            <input type="text" placeholder='Enter your College ID' className='bg-black text-white placeholder-white w-[35vw] py-2 px-4 mt-4 rounded-3xl'/>
